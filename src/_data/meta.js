...
export const siteName = 'Arkansas FGC';
export const siteDescription = 'Resources to find and interact with the fighting game community in Arkansas';
...
export const creator = {
  name: 'Taylor Blanton', // i.e. Lene Saile - creator's (developer) name.
  email: 'taylor@taylorblanton.com',
  website: 'https://www.taylorblanton.com',
};
